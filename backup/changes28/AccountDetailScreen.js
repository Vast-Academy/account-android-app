...
const AccountDetailScreen = ({route, navigation}) => {
  ...
  const [showWithdrawModeError, setShowWithdrawModeError] = useState(false);
  ...
  useEffect(() => {
    if (withdrawModalVisible) {
      ...
      setShowWithdrawModeError(false);
    }
                ...
                <View style={styles.modeOption}>
                  <TouchableOpacity
                    style={[
                      ...
                      showWithdrawModeError && styles.modeButtonError,
                    ]}
                    onPress={() => {
                ...
                onPress={async () => {
                  if (!withdrawMode) {
                    if (withdrawAmount.trim()) {
                      showToast(
                        'Select Withdraw or Transfer to continue.',
                        'error'
                      );
                      setShowWithdrawModeError(true);
                    } else {
                      Alert.alert(
                        'Select Option',
