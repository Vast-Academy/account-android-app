...
const AccountDetailScreen = ({route, navigation}) => {
  ...
  const runModeHighlightSequence = useCallback(() => {
    ...
    const sequence = ['withdraw', 'transfer', 'withdraw'];
    const stepMs = 320;
    ...
    highlightTimersRef.current.push(resetTimer);
  }, [clearHighlightTimers]);
  ...
  }, [withdrawModalVisible, withdrawDefaultMode, clearHighlightTimers]);
                ...
                <View style={styles.modeOption}>
                  <TouchableOpacity
                    style={[
                      ...
                      highlightedMode === 'withdraw' && styles.modeButtonError,
                    ]}
                    onPress={() => {
                ...
                <View style={styles.modeOption}>
                  <TouchableOpacity
                    style={[
                      ...
                      highlightedMode === 'transfer' && styles.modeButtonError,
                    ]}
                    onPress={() => {
                ...
                onPress={async () => {
                  if (!withdrawMode) {
                    if (withdrawAmount.trim()) {
                      ...
                      Alert.alert(
                        'Select Option',
                        'Please select Withdraw or Transfer first.'
                      );
                    }
                    return;
                  }
