                    ...
                    <View style={styles.modeButtonContent}>
                      <Animated.Text
                        style={[
                          ...
                          {
                            color: withdrawPulse.interpolate({
                              inputRange: [0, 1],
                              outputRange: [colors.text.secondary, '#EF4444'],
                            }),
                          },
                        ]}>
                        Withdraw
                    ...
                    <View style={styles.modeButtonContent}>
                      <Animated.Text
                        style={[
                          ...
                          {
                            color: transferPulse.interpolate({
                              inputRange: [0, 1],
                              outputRange: [colors.text.secondary, '#EF4444'],
                            }),
                          },
                  ...
                  <AnimatedTouchableOpacity
                    ...
                    <Animated.Text
                      style={[
                        ...
                        {
                          color: defaultPulse.interpolate({
                            inputRange: [0, 1],
                            outputRange: [colors.text.secondary, '#10B981'],
                          }),
                        },
                      ]}>
                      Set as default
